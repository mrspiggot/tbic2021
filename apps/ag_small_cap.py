...
def small_cap_treemap():
    d = {'M': '*0.001', 'B': ''}
    df = pd.read_html('https://finance.yahoo.com/screener/predefined/aggressive_small_caps')[0]
...
def small_cap_table():
    ...
    return table
layout = html.Div([
    html.H1('Research Ideas - Aggressive Medium and Small Cap Stocks', style={'textAlign': 'center'}),
    html.H6('1 yr. % Change in EPS (Basic): greater than 25', style={'textAlign': 'center'}),
